...
"""
    Taken from https://github.com/dennybritz/reinforcement-learning as a test of the difference between RBF versus no RBF
"""
...
class Agent:
    def __init__(self, ft, input_dim, output_dim, hidden_layers=[32, 32], policy_lr=1e-3, v_lr=1e-3, v_update_steps=80):
...
if __name__ == '__main__':
    ...
    parser.add_argument("--path", type=str, default="models/mountaincar_model")
    ...
    agent = Agent(ft, ft.dimensions, env.action_space.shape[0], hidden_layers=[], 
